...
defined('_JEXEC') or die();
	...
	'{"fields": {
		...
		"_id":{
			"type":"layout",
			"settings": {
				'./* it inherits all settings options from select plus have it's own */'
		...
		"_id":{
			"type":"apps",
			"settings": {
				'./* it inherits all settings options from select */'
			}
		},
		...
		"_id":{
			"type":"types",
			"settings": {
				'./* it inherits all settings options from select plus */'
				"submissions":{
