...
class plgSystemZlframeworkInstallerScript
{
	...
	protected $_obsolete = array(
		'files'	=> array(
			...
			'plugins/system/zlframework/zlframework/changelog.txt',
			'plugins/system/zlframework/zlframework/classes/wk2trsf.php',
		...
		'folders' => array(
			...
			'plugins/system/zlframework/zlframework/vendor/uikit',
			'plugins/system/zlframework/zlframework/vendor/zlux',
