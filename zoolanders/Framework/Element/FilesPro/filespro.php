...
namespace Zoolanders\Framework\Element\FilesPro;
...
abstract class FilesPro extends RepeatablePro implements FilesInterface
{
    ...
    */
    public function __construct()
    {
        ...
        $this->drive = $this->container->drive->createFromElement($this);
    ...
    */
    protected function getDefaultSource()
    {
        ...
        return $this->replaceVars($default_source);
    }
    ...
    */
    public function validateSubmission($value, $params)
    {
        ...
        //rewind the index to build the correct control name
        $this->rewind();
        ...
        // add parameter uniqid for default layout: operate with index after array reindexing
    ...
    public function submissionBeforeSave($event)
    {
        ...
        foreach ($userfiles as $userfile) {
            ...
            if ($userfile && $userfile['error'] == 0 && is_array($userfile)) {
                ...
                // resize
                $crop_config = $this->config->find('files.resize');
                $this->app->zlfw->resizeImage("$targetDir/$fileName", (int)$crop_config['width'], (int)$crop_config['height'], (int)($crop_config['crop'] == false), $unique = null, $cache = false, (isset($crop_config['avoid_resize_small']) ? (int)$crop_config['avoid_resize_small'] : 0));
